...
var generateId = function (numbers) {
  if ( numbers === void 0 ) numbers = 7;

  var uniqueKey = Math.random().toString(36).substr(2, (2 + numbers)); // should be unique because of the seed
  return ("_" + uniqueKey)
};
...
var ScrollContainer = {
  ...
  provide: function provide () {
    ...
    return { $scrollMonitor: $scrollMonitor }
  },
  props: {
    debug: {
      default: true,
  ...
  methods: {
    updateInternalState: function updateInternalState (o) {
      ...
      var isBelowViewport = o.isBelowViewport;
      var isFullyInViewport = o.isFullyInViewport;
      var isInViewport = o.isInViewport;
      var id = o._id;
      this.state[id] = {
    ...
    teardownWatchers: function teardownWatchers () {
     ...
     */
    updateWatcher: function updateWatcher (id, el, options) {
      if ( options === void 0 ) options = {};

      this._scrollWatchers = this._scrollWatchers || [];
      var lock = options.lock;
      var offset = options.offset;
      var watcherIndex = this._scrollWatchers.findIndex(function (ref) {
        var _id = ref._id;

        return _id === id;
      });
      var alreadyExist = watcherIndex !== -1;

      var watcher = alreadyExist ? this._scrollWatchers[watcherIndex] : undefined;
    ...
    generateWatcher: function generateWatcher (id, el, offset) {
      var watcher = this._container.create(el, offset);
      watcher._id = id;
      return watcher
    },
    unregisterWatcher: function unregisterWatcher (id) {
      var watcherIndex = this._scrollWatchers.findIndex(function (ref) {
        var _id = ref._id;
    ...
    setupReactiveState: function setupReactiveState (key) {
...
var ScrollItem = {
  ...
  render: function render (h) {
    ...
    if (this.state) {
      ...
      var classString = Object.values(this.state).reduce(function (sum, val, i) {
        var k = keys[i];
        return [val ? k : undefined, sum].filter(function (val) { return val; }).join(' ')
      }, null);
      var mergedClassString = [classString.toLowerCase(), get(vNode, 'data.staticClass', '')]
        .join(' ');
  ...
  beforeMount: function beforeMount () {
    ...
    this.$nextTick(function () {
      this$1._scrollwatcher = this$1.$scrollMonitor.registerWatcher(this$1.id, this$1.$el, { offset: this$1.offset, lock: this$1.lock });
    });
  },
  destroyed: function destroyed () {
...
(function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css=" html { background: #272822; } .left { min-width: 480px; } .sidebar.isaboveviewport { position: fixed; top: 0; } .bloc{ transition: background-color .3s ease-in-out; } "; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();
var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"pa4"},[_vm._m(0),_c('div',[_c('scroll-container',{staticClass:"flex",on:{"change":_vm.updateState}},[_c('div',{staticClass:"flex-auto left"},[_c('scroll-item',{attrs:{"lock":true}},[_c('div',{staticClass:"sidebar"},[_c('prism',{attrs:{"language":"javascript"}},[_vm._v(_vm._s(_vm.itemsInViewport))])],1)])],1),_c('div',{},_vm._l((10),function(i){return _c('scroll-item',{key:i,attrs:{"id":i},on:{"change":_vm.onChange}},[_c('p',{class:("bloc mb4 mt0 pa6 f3 b tc white " + (_vm.state[i] && _vm.state[i].isFullyInViewport ? 'bg-blue' : 'bg-light-blue'))},[_vm._v(_vm._s(i))])])}))])],1)])},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('h1',{staticClass:"white"},[_vm._v("Vue"),_c('span',{staticClass:"blue"},[_vm._v("ScrollMonitor")])])}],
  name: 'Example',
  components: {
    ...
    test: {
      ...
      var props = ref.props;
 console.log('refresh', props.state); return h('div', ("" + (JSON.stringify(props.state)) + (Math.random()))) }
    }
  },
  data: function () { return ({
    state: {},
  ...
  computed: {
    itemsInViewport: function itemsInViewport() {
      return _.pickBy(this.state, function (ref) {
        var isInViewport = ref.isInViewport;
